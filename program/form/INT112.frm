...
Begin VB.Form INT112 
   Caption         =   "입학사정 >> 입학원서 출력 >> 종합 입학원서 출력 (마강)"
   ClientHeight    =   10800
   ClientLeft      =   555
   ClientTop       =   2970
   ClientWidth     =   15240
   ...
   Begin VB.PictureBox pReportControl 
      ...
      Begin VB.PictureBox pReportViewer 
         ...
         Begin VB.Label OPTIONS 
            BackColor       =   &H00E0E0E0&
            BackStyle       =   0  '투명
            Caption         =   "▶자연계: 국어A, 수학B, 영어B형으로 수업합니다."
            BeginProperty Font 
               Name            =   "굴림"
               Size            =   8.25
               Charset         =   129
         ...
         Begin VB.Label OPTIONS 
            BackStyle       =   0  '투명
            Caption         =   "※ 서울대 지망학생은 서로 다른 과목의 (Ⅰ+Ⅱ) 또는 (Ⅱ+Ⅱ) 선택 "
            BeginProperty Font 
               Name            =   "굴림"
               Size            =   8.25
               Charset         =   129
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INT112.frx":0035
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "INT112"
...
'            OPTIONS(0) = "▶국어B, 수학A, 영어B형으로 수업합니다."
'            OPTIONS(1) = "▶국어A, 수학B, 영어B형으로 수업합니다."
'            OPTIONS(2) = ""
'
'            Labels(2).Caption = ""
'            Labels(78).Caption = ""
...
'                                     Case "M":  접수계열.Text = "서울인문"
'                                                접수계열2.Text = "서울인문"
'                              End Select
'
'            Case "22":        Select Case Trim(basModule.SchCD)
'                                     Case "M":  접수계열.Text = "서울자연"
'                                                접수계열2.Text = "서울자연"
'                              End Select
'            Case Else:  접수계열.Text = ""
'        End Select
