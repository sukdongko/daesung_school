...
Begin VB.Form STD010_N_TEST 
   ...
   Begin VB.ComboBox cbo_Clinic_L 
      Height          =   300
      Left            =   990
      Style           =   2  '드롭다운 목록
      TabIndex        =   219
      ...
      Begin VB.Frame Frame9 
         ...
         Begin VB.Frame Frame17 
            ...
            Begin VB.Frame fraSEL5 
               ...
               Top             =   30
               Width           =   8175
               Begin VB.ComboBox cbo_Clinic_E 
                  Height          =   300
                  Left            =   5520
                  Style           =   2  '드롭다운 목록
                  TabIndex        =   230
                  ...
                  Width           =   1695
               End
               Begin VB.ComboBox cbo_Clinic_M 
                  Height          =   300
                  Left            =   3150
                  Style           =   2  '드롭다운 목록
                  TabIndex        =   229
   ...
   Begin VB.Frame Frame18 
      ...
      Begin VB.Frame Frame19 
         ...
         Begin FPSpread.vaSpread sprSTD_F 
            ...
            ProcessTab      =   -1  'True
            Protect         =   0   'False
            SpreadDesigner  =   "STD010_N_TEST.frx":0000
         End
         ...
         Begin VB.Image imgExcel 
            Height          =   420
            Left            =   6120
            Picture         =   "STD010_N_TEST.frx":2264
            Stretch         =   -1  'True
            Top             =   1440
            Width           =   390
         End
   ...
   Begin VB.Frame Frame20 
      ...
      Begin VB.Frame Frame21 
         ...
         Begin FPSpread.vaSpread sprExcel_STD_Data 
            ...
            MaxCols         =   16
            ProcessTab      =   -1  'True
            SpreadDesigner  =   "STD010_N_TEST.frx":26A5
         End
         ...
         Begin VB.Label Label30 
            BackStyle       =   0  '투명
            Caption         =   $"STD010_N_TEST.frx":42BB
            Height          =   615
            Left            =   240
            TabIndex        =   44
            Top             =   630
   ...
   Begin VB.Frame fraGwamok 
      ...
      Begin VB.Frame Frame23 
         ...
         Begin VB.Image Image1 
            Height          =   4080
            Left            =   -30
            Picture         =   "STD010_N_TEST.frx":4352
            Top             =   240
            Width           =   8730
         End
      End
   ...
   Begin VB.Frame fraPoint 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin FPSpread.vaSpread sprPoint 
            ...
            MaxCols         =   9
            ProcessTab      =   -1  'True
            SpreadDesigner  =   "STD010_N_TEST.frx":BA1C
         End
   ...
   Begin FPSpread.vaSpread sprStdData 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "STD010_N_TEST.frx":D3F2
   End
   ...
   End
End
Attribute VB_Name = "STD010_N_TEST"
...
'
'    '<< 계열 >> : 2008.02.15
'        Select Case Trim(basModule.SchCD)               '< 송파, 마송
'            Case "S"
''                .AddItem "예체능" & Space(30) & "03"
''
''                .AddItem "인문수능" & Space(30) & "05"
...
'        .AddItem "2012 6월 평가원" & Space(30) & "2"
'        .AddItem "2012 9월 평가원" & Space(30) & "3"
'        .AddItem "없음" & Space(30) & "X"
'
'        .Enabled = True
'
...
'                    Next ni
'
''                    If Trim(Right(cboKaeyol.Text, 30)) = "18" Then
''                        optExmN.Value = True
''                    Else
''                        optExmY.Value = True
''                    End If
...
'                    Next ni
'
''                    If Trim(Right(cboKaeyol.Text, 30)) = "19" Then
''                        optExmN.Value = True
''                    Else
''                        optExmY.Value = True
''                    End If
...
'<< 계열 >> : 2008.02.15
    ...
    Select Case Trim(Right(cboPassCN, 30))
        Case "ALL"      ' /* 합격생은 모두 조회 */
            ...
            sStr = sStr & "              MAX(K_NUM) AS K_NUM, MAX(M_NUM) AS M_NUM, MAX(E_NUM) AS E_NUM, MAX(T_NUM) AS T_NUM, MAX(TOT_NUM) AS TOT_NUM, "
            ...
            sStr = sStr & "                      0 AS K_NUM, 0 AS M_NUM, 0 AS E_NUM, 0 AS T_NUM, 0 AS TOT_NUM, "
...
Private Sub Show_Select_STD(ByVal aSchNO As String)
    ...
    sStr = sStr & "         SEL1    , SEL2    , SEL3    , SEL4    , SEL5    ,SEL6,"
    sStr = sStr & "         K_NUM   , M_NUM   , E_NUM   ,T_NUM, TOT_NUM ,"
...
'<< 계열 >> : 2009.01.09
    ...
    sStr = sStr & "         (NVL(K_NUM,0)+NVL(M_NUM,0)+NVL(E_NUM,0)+NVL(T_NUM,0)) AS 전체점수,"
