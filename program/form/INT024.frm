...
Begin VB.Form INT024 
   Caption         =   "입학사정 >> 입학원서 출력 >> 부산 입학원서 출력"
   ClientHeight    =   10545
   ClientLeft      =   3735
   ClientTop       =   3420
   ClientWidth     =   14145
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INT024.frx":1406
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "INT024"
...
Private Sub cmdFind_Click()
    ...
    Select Case Trim(basModule.SchCD)
        ...
        Case Else
            MsgBox "부산대성학원이 아닌 경우 출력물이 다를 수 있습니다.", vbExclamation + vbOKOnly, "학생조회"
    End Select
...
Private Sub Get_STD_Data()
    ...
    sStr = sStr & "           WHERE EXMROUND LIKE 'BS081126%'"
    
'>> 계열
    Select Case Trim(Right(cboKaeyol, 30))
        Case "XX"
            ' no action
            sStr = sStr & "     AND KEYOL IN ( '1', '2') "
        Case "01", "03"
    ...
    With DBRec
        If .RecordCount > 0 Then
            ...
            For nRec = 1 To .RecordCount Step 1
                ...
                If IsNull(.Fields("ORD_NO")) = False Then uSTD(nRec).ORDNO = .Fields("ORD_NO")
