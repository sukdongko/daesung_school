...
Begin VB.Form INT014 
   Caption         =   "입학사정 >> 입학원서 출력 >> 선행 입학원서 출력(양재)"
   ClientHeight    =   11010
   ClientLeft      =   1005
   ClientTop       =   2055
   ClientWidth     =   15090
   ...
   Begin VB.PictureBox pReportControl 
      ...
      Begin VB.PictureBox pReportViewer 
         ...
         Begin VB.TextBox 선택_사회탐구 
            ...
            Left            =   3390
            TabIndex        =   48
            Text            =   "국사( ), 윤리( ), 경제( ), 한국근·현대사( ), 정치( ), 사회·문화( ), 한국지리( )"
            Top             =   6670
            Width           =   6615
         End
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INT014.frx":0000
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "INT014"
...
'>> 학년별 내역
    Select Case Trim(basModule.SchCD)
        ...
        Case "J", "B"
            OPTIONS(0) = "▶인문계(국어B, 수학A, 영어B형)/자연계(국어A, 수학B, 영어B형)으로 수업합니다."
            OPTIONS(1) = "▶인문계 사회탐구 중 세계사, 세계지리, 동아시아사, 생활과 윤리 및 제2외국어는 정규반에서 선택하여 수강할 수 있습니다."
            OPTIONS(2) = "▶자연계 과학탐구 중 물리Ⅱ, 지구과학Ⅱ는 정규반에서 선택하여 수강할 수 있습니다."
            OPTIONS(5) = "▶선택과목의 신청자 수가 극소수일 경우 개설되지 않을 수도 있습니다. "
...
'            FillBOXs_opt(21).Visible = False
        ...
        Case "M"
            OPTIONS(0) = "▶인문계 사회탐구 중 세계사, 법과 사회, 경제지리, 세계지리 및 제2외국어는 정규반에서 선택하여 수강할 수 있습니다."
            'OPTIONS(1) = "▶자연계 수리영역 선택과목은 미적분 수업만 하며, 확률통계와 이산수학은 수업하지 않습니다."
            OPTIONS(1) = "▶자연계 과학탐구 중 물리II, 화학II, 생명과학II, 지구과학II는 정규반에서 선택하여 수강할 수 있습니다."
            OPTIONS(2) = ""
...
Private Sub Get_STD_Data()
    ...
    sStr = sStr & "         K_NUM      , M_NUM      , E_NUM      , N_NUM      , TOT_NUM    ,"
...
'    End Select
    ...
    sStr = sStr & "    FROM ( "
            ...
            sStr = sStr & "         MAX(PHOTO_PATH) AS PHOTO_PATH , MAX(R_WAY     ) AS R_WAY      , MAX(PTS_SEL   ) AS PTS_SEL   , MAX(ORD_NO    ) AS ORD_NO    , MAX(MU_TYPE) AS MU_TYPE "
...
Private Sub Std_Data_Show(Index As Long)
    ...
    With uSTD(Index)
        ...
        수험번호.Text = .EXMID
        학생성명.Text = .STDNM:                 등급.Text = .MU_TYPE
        성별.Text = .SEX
        생년월일.Text = .Birth_ymd
        학생우편번호.Text = "(" & .ZIP & ")"
        학생주소1.Text = .ADDR1
