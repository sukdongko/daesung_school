   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INT023.frx":1406
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "INT023"
...
Private Sub cmdFind_Click()
    ...
    Select Case Trim(basModule.SchCD)
        ...
        Case Else
            MsgBox "양재 대성학원이 아닌 경우 출력물이 다를 수 있습니다.", vbExclamation + vbOKOnly, "학생조회"
    End Select
...
Private Sub Get_STD_Data()
    ...
    sStr = sStr & "         HOPE_ACACD, SEX, KEYOL, Birth_ymd, "
    ...
    sStr = sStr & "                 HOPE_ACACD, SEX, NVL(KEYOL,'1') AS KEYOL, SUBSTR(Birth_ymd, 1, 4)||'-'||SUBSTR(Birth_ymd, 5, 2) ||'-'||SUBSTR(Birth_ymd, 7, 2) AS Birth_ymd, "
    sStr = sStr & "                 SEL1, SEL2, SEL3, SEL4, SEL5, PTS_SEL, PTS1, PTS2, "
    ...
    sStr = sStr & "           WHERE EXMROUND LIKE 'YJ081126%'"
    
'>> 계열
    Select Case Trim(Right(cboKaeyol, 30))
        Case "XX"
            sStr = sStr & "     AND (KEYOL IS NULL OR KEYOL IN ('1','2') ) "
        Case "01", "03"
    ...
    With DBRec
        If .RecordCount > 0 Then
            ...
            For nRec = 1 To .RecordCount Step 1
                ...
                If IsNull(.Fields("ORD_NO")) = False Then uSTD(nRec).ORD_NO = .Fields("ORD_NO")     '< 추가
                ...
                If IsNull(.Fields("Birth_ymd")) = False Then uSTD(nRec).Birth_ymd = .Fields("Birth_ymd")
...
Private Sub Std_Data_Show(Index As Long)
    ...
    With uSTD(Index)
        ...
        Set Photo.Picture = CheckJPG(sSavePath & "\" & .ORD_NO & ".jpg")
...
Private Sub Get_STD_image()
    ...
    For nRec = 1 To UBound(uSTD) Step 1
        ...
        sLocalFile = sSavePath & "\" & uSTD(nRec).ORD_NO & ".jpg"                    '<< unique key : 학생코드
