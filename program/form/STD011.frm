...
Begin VB.Form STD011 
   Caption         =   "입학사정 >> 학생전체 조회"
   ClientHeight    =   9540
   ClientLeft      =   3360
   ClientTop       =   1935
   ClientWidth     =   15060
   ...
   Begin VB.Frame Frame18 
      ...
      Begin VB.Frame Frame19 
         ...
         Begin FPSpread.vaSpread sprSTD_F 
            ...
            EndProperty
            MaxCols         =   78
            SpreadDesigner  =   "STD011.frx":0000
         End
...
'    sStr = sStr & "         decode(SEL2_SCH,'E','강남기숙이천', 'J','강남양재', 'M','강남M' ,'S','송파', 'N','노량진','해당학원없음') AS 학원2지망   , "
...
Private Sub imgExcel_Click()
    ...
    '학생 엑셀 쿼리문
    sStr = basCommonSTD.Get_StdExcuteSqlToExcel(cboKaeyol_F.Text, fpDay1.UnFmtText, fpDay2.UnFmtText)
