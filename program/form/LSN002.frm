...
Begin VB.Form LSN002 
   Caption         =   "시간표 만들기 >> 이동반 정보 등록"
   ClientHeight    =   9675
   ClientLeft      =   7650
   ClientTop       =   4185
   ClientWidth     =   9075
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread sprDisp 
            ...
            EndProperty
            MaxCols         =   10
            SpreadDesigner  =   "LSN002.frx":0000
         End
...
Private Function Save_Lsn_Data() As Boolean
    ...
    sStr = ""
    sStr = sStr & "  SELECT GET_LSN_MVCD AS LSNCD FROM DUAL "
    ...
    '<< INSERT
    sStr = ""
    sStr = sStr & "  INSERT INTO SDLSN02TB (ACID, LSNCD, LSNNM, LSNCDNM, KAEYOL, DAMIM, BASE_CLASS, LSNCAPA, LSN_CL) "
    sStr = sStr & "  VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ? )"
