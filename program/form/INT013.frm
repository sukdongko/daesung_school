...
Begin VB.Form INT013 
   Caption         =   "입학사정 >> 입학원서 출력 >> 선행 입학원서 출력(마이맥강남)"
   ClientHeight    =   11010
   ClientLeft      =   1005
   ClientTop       =   2055
   ClientWidth     =   15090
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INT013.frx":006B
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "INT013"
...
'>> 학년별 내역
    Select Case Trim(basModule.SchCD)
        ...
        Case "M"
            OPTIONS(0) = "▶인문계 사회탐구 중 세계사, 세계지리, 동아시아사, 생활과 윤리 및 제2외국어는 정규반에서 선택하여 수강할 수 있습니다."
            OPTIONS(1) = "▶인문계(국어B, 수학A, 영어B형)/자연계(국어A, 수학B, 영어B형)으로 수업합니다."
            OPTIONS(2) = ""
...
'        End If
        ...
        Select Case Trim(basModule.SchCD)
            ...
            Case Else
                Select Case Trim(.KAEYOL)
                    Case "01", "04", "05", "06", "07", "08", "09", "10", "11", "12", "14", "15", "16"
                        수리선택.Caption = IIf(Trim(.SEL4) > " ", "수리[가]", "수리[나]")
                    Case "02"
                        수리선택.Caption = "수리[가]"
'                    Case "04"
