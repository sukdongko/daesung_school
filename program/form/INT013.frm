...
Private Sub fpExmID_E_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        If Trim(fpExmID_E.Text) > " " Then
            Call cmdFind_Click
        End If
    End If
End Sub

Private Sub txtStdNM_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        If Trim(txtStdNM.Text) > " " Then
            Call cmdFind_Click
        End If
