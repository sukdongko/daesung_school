   ...
   Begin VB.PictureBox pReportControl 
      ...
      Begin VB.PictureBox pReportViewer 
         ...
         Begin VB.Label Labels 
            BackColor       =   &H00E0E0E0&
            BackStyle       =   0  '투명
            Caption         =   "▼유시험 응시자 중 응시학원 외에 다른 학원에서 수강을 원할 경우 2지망을"
            BeginProperty Font 
               Name            =   "굴림"
               Size            =   8.25
               Charset         =   129
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INT111.frx":0000
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "INT111"
...
'            FillBOXs_opt(21).Visible = False
        ...
        Case "J", "B"
            ...
            OPTIONS(1) = "▶제2외국어 시간에 제2외국어를 하지 않는 학생들은 위해 언어,수리를 동시간에 편성하니 1과목을 선택하시기 바랍니다."
            OPTIONS(2) = "▶자연계 학생들은 과학I 에서는 3과목, II 에서는 1과목을 선택해야 합니다."
...
'            FillBOXs_opt(21).Visible = False
        ...
        Case "M"
            OPTIONS(21) = "※I에서 한과목 선택 또는 I에서 2과목, II에서 1과목 선택"
...
Private Sub Get_STD_Data()
    ...
    sStr = sStr & "         SCHNO      , ACID       , EXMID      , STDNM      , SUBSTR(JUMIN,1,6)||'-'||SUBSTR(JUMIN,7,7) AS JUMIN,"
...
'    Select Case Trim(basModule.SchCD)
'        Case "S"
'            sStr = sStr & " DECODE(GR,'1','수능등급','2','2009 평가','','') AS GR, "
'        Case "P"
'            sStr = sStr & " DECODE(GR,'8','수능등급','9','2009 평가','6','3등급','','') AS GR, "
'        Case Else
'            sStr = sStr & " '' AS GR, "
'    End Select
    ...
    sStr = sStr & "    FROM ( "
            ...
            sStr = sStr & "               ("
                    ...
                    sStr = sStr & "                DECODE(TRIM(SUB_ID), '03', DECODE(SUB_NUM,'X',0, SUB_NUM), '53', DECODE(SUB_NUM, 'X',0, SUB_NUM), 0) AS J06,    /* 사탐-경제        , 과탐-생물1             */"
                    sStr = sStr & "                DECODE(TRIM(SUB_ID), '03', DECODE(SUB_BAK,'X',0, SUB_BAK), '53', DECODE(SUB_BAK, 'X',0, SUB_BAK), 0) AS K06,    /* 백분위  사탐-경제        , 과탐-생물1     */"
                    ...
                    sStr = sStr & "                DECODE(TRIM(SUB_ID), '07', DECODE(SUB_NUM,'X',0, SUB_NUM), '57', DECODE(SUB_NUM, 'X',0, SUB_NUM), 0) AS J10,      /* 사탐-한국지리    , 과탐-생물2           */"
                    sStr = sStr & "                DECODE(TRIM(SUB_ID), '07', DECODE(SUB_BAK,'X',0, SUB_BAK), '57', DECODE(SUB_BAK, 'X',0, SUB_BAK), 0) AS K10,      /* 백분위 사탐-한국지리    , 과탐-생물2    */"
    ...
    With DBRec
        ...
        ElseIf .RecordCount > 0 Then
            ...
            For nRec = 1 To .RecordCount Step 1
                ...
                sTmp = "":      If IsNull(.Fields("JUMIN")) = False Then sTmp = .Fields("JUMIN")
                    uSTD(nRec).JUMIN = sTmp
...
'                                    2010.12.14 김한욱 CLSTD01TB상에서 SEL 구분 때문에 변경
