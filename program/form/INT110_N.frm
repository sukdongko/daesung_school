...
Begin VB.Form INT110_N 
   Caption         =   "입학사정 >> 입학원서 출력 >> 종합 입학원서 출력 2012년도 (노량진,송파)"
   ClientHeight    =   10845
   ClientLeft      =   2010
   ClientTop       =   2805
   ClientWidth     =   14685
...
'>> 학년별 내역
    Select Case Trim(basModule.SchCD)
        ...
        Case "N"
            ...
            Labels(45) = ""
            Labels(68) = "(택3)"
            OPTIONS(0) = "▶서울대 지망학생은  사회탐구 과목 중 국사는 필수입니다."
            OPTIONS(1) = "▶제2외국어 시간에 제2외국어를 하지 않는 학생들을 위해 언어.수리.외국어를 동시간대에 편성하니 선택하시기 바랍니다."
            OPTIONS(2) = "▶자연계 학생 중 수리(나)형을 지원하는 학생은 별도 표기하시기 바랍니다."
            OPTIONS(5) = "▶반당 수강생 수 증감에 따라 분반 또는 합반할 수 있습니다."
    ...
    With DBRec
        ...
        ElseIf .RecordCount > 0 Then
            ...
            For nRec = 1 To .RecordCount Step 1
                ...
                nTmp = 0:      If IsNumeric(.Fields("T_NUM")) = True Then nTmp = .Fields("T_NUM")
                    uSTD(nRec).T_NUM = nTmp
                    ...
                    Case "N":
                        Select Case Trim(.GR)
                            ...
                            Case "7":
                                ...
                                If IsNumeric(Trim(.T_NUM)) = True Then nKME_Sum = nKME_Sum + CDbl(.T_NUM)
