...
Begin VB.Form INT110_N 
   Caption         =   "입학사정 >> 입학원서 출력 >> 종합 입학원서 출력 2012년도 (노량진)"
   ClientHeight    =   10800
   ClientLeft      =   2010
   ClientTop       =   2805
   ClientWidth     =   14685
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INT110_N.frx":0150
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "INT110_N"
...
Private Sub Clear_Form_Control()
    ...
    과탐비고.Visible = False
    과탐비고.Text = "※ 서울대 지망학생은 서로 다른 과목의 (Ⅰ + Ⅱ) 또는 (Ⅱ + Ⅱ) 선택"
...
Private Sub Get_STD_Data()
    ...
    sStr = sStr & "    FROM ( "
            ...
            End If
            '>> 계열
            If Trim(Right(cboKaeyol.Text, 30)) <> "ALL" Then      ' 인문
