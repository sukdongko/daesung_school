...
Begin VB.Form INT012 
   Caption         =   "입학사정 >> 입학원서 출력 >> 선행 입학원서 출력"
   ClientHeight    =   10590
   ClientLeft      =   1725
   ClientTop       =   3195
   ClientWidth     =   14700
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INT012.frx":0145
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "INT012"
...
'>> 학년별 내역
    ...
    Select Case Trim(basModule.SchCD)
        ...
        Case "N"
            OPTIONS(0) = "▶ 선행학습반 인문계는 선택과목 7과목 중 3과목을 선택할 수 있으며, 세계지리, 세계사, 법과사회, 경제지리, 제2외국어 과목은 정규 종합반부터 수업합니다."
            OPTIONS(1) = "▶ 선행학습반 자연계는 선택과목 4과목 중 3과목을 선택할 수 있으며, 과학∥(4과목), 정규 종합반부터 수업합니다."
