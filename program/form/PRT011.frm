...
Begin VB.Form PRT011 
   ...
   Begin FPSpread.vaSpread sprLsn 
      ...
      MaxCols         =   2
      ScrollBars      =   2
      SpreadDesigner  =   "PRT011.frx":0000
   End
   Begin FPSpread.vaSpread sprinFo 
      ...
      ProcessTab      =   -1  'True
      ScrollBars      =   0
      SpreadDesigner  =   "PRT011.frx":184D
   End
   Begin FPSpread.vaSpread sprTime 
      ...
      ProcessTab      =   -1  'True
      ScrollBars      =   0
      SpreadDesigner  =   "PRT011.frx":1D0B
   End
...
Private Sub Form_Load()
    ...
    Me.Tag = "LOAD"
        ...
        With cboKaeyol
            .Clear
            .AddItem "¿¸√º" & Space(30) & "ALL"
            .AddItem "¿ŒπÆ" & Space(30) & "01"
            .AddItem "¿⁄ø¨" & Space(30) & "02"
            .ListIndex = 0
        End With
...
'/* ¿Ãµøπ› ## */
    ...
    sStr = sStr & "               DECODE(B.KAEYOL,'01','¿ŒπÆ∞Ë','02','¿⁄ø¨∞Ë','03','øπ√º¥…') AS GAEYUL,"
    sStr = sStr & "               B.CLASSNM, B.DAMIM,"
    sStr = sStr & "               A.IDX,"
    sStr = sStr & "               A.LSNCDNM,"
    sStr = sStr & "               DECODE(A.LSNNM,'πÊº€ºˆæ˜','','∞¯≈Î') AS TCRNM,"
    ...
    sStr = sStr & "                                       DECODE(SUBSTR(PRT_KAEYOL,1,1),'1','¿ŒπÆ∞Ë','2','¿⁄ø¨∞Ë','±‚≈∏') AS GAEYUL,"
...
Private Sub Disp_TimeTable_All_Data(ByVal aindex As Long)
    ...
    If UBound(uTimeTable) >= aindex Then
        ...
        '// 1. header
            LHD(0).Caption = "∞Ëø≠ : " & .GAEYUL:       RHD(0).Caption = "∞Ëø≠ : " & .GAEYUL
            LHD(1).Caption = "π› : " & .LSNNM:          RHD(1).Caption = "π› : " & .LSNNM
            LHD(2).Caption = "±≥Ω« : " & .CLASS_NM:     RHD(2).Caption = "±≥Ω« : " & .CLASS_NM
            LHD(3).Caption = "¥„¥Á : " & .DAMIM:        RHD(3).Caption = "¥„¥Á : " & .DAMIM
