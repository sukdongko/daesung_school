...
Begin VB.Form INT022 
   Caption         =   "입학사정 >> 입학원서 출력 >> 노량진 입학원서 출력"
   ClientHeight    =   10575
   ClientLeft      =   2115
   ClientTop       =   2100
   ClientWidth     =   14220
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INT022.frx":1406
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "INT022"
...
Private Sub Get_STD_Data()
    ...
    sStr = sStr & "           WHERE EXMROUND LIKE 'NR081126%'"
